...
class TestText(unittest.TestCase):
    ...
    def test_prepare_white_space(self):
        ...
        success = "I am a test case. My carriage returns and white space shopuld be changed."
    ...
    def test_prepare_punctuation_and_white_space(self):
        ...
        success = "I am a test case. My formatting is sloppy... I keep leaving out a space after a full stop, my email is python@coding.net."
